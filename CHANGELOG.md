...
- **Android Launcher**:
    ...
    - Device-level security: 5-minute inactivity triggers `lockNow()` (system PIN/biometric); launcher prompts system lock setup if no device credential is set; “Change PIN” now opens system lock settings.
