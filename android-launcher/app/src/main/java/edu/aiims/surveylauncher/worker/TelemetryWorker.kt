package edu.aiims.surveylauncher.worker
...
import edu.aiims.surveylauncher.LauncherApplication
import edu.aiims.surveylauncher.data.SessionManager
import edu.aiims.surveylauncher.data.db.TelemetryEntity
import edu.aiims.surveylauncher.data.network.ApiService
import edu.aiims.surveylauncher.data.network.TelemetryEvent
import edu.aiims.surveylauncher.data.network.TelemetryRequest
...
class TelemetryWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            ...
            val gson = Gson()
            val policyConfig = gson.fromJson(policyResponse.config, edu.aiims.surveylauncher.data.network.PolicyConfig::class.java)
            
            // Update KioskManager with allowed apps
            val kioskManager = edu.aiims.surveylauncher.util.KioskManager(applicationContext)
