...
import edu.aiims.surveylauncher.data.network.LogoutRequest
import edu.aiims.surveylauncher.data.network.UserData
import edu.aiims.surveylauncher.ui.registration.RegistrationScreen
...
import edu.aiims.surveylauncher.ui.theme.SurveyLauncherTheme
        ...
        if (kioskManager.isDeviceOwner()) {
            ...
            if (policyJson != null) {
                try {
                    ...
                    val policy = gson.fromJson(policyJson, edu.aiims.surveylauncher.data.network.PolicyConfig::class.java)
