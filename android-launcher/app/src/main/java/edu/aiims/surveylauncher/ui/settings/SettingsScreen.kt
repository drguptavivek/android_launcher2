...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            SectionCard("Information") {
                ...
                if (syncStatus.isNotEmpty()) {
                    ...
                    Text(
                        ...
                        color = if (syncStatus.startsWith("✅")) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.error
                    )
                }
            }
            ...
            SectionCard("PIN / Theme / Permissions") {
                Button(
                    onClick = onChangePin,
            ...
            SectionCard("Account Management") {
                Button(
                    onClick = onLogout,
                    modifier = Modifier.fillMaxWidth(),
                    colors = ButtonDefaults.buttonColors(containerColor = MaterialTheme.colorScheme.error)
